...
function SuccessFullPay() {
  ...
  const discount = getSearchParam("discount");
  const totalCount = getSearchParam("total");
  return (
    <>
      <Topbar />
      <Navbar />
      <div className="container mt-14">
        ...
        <div className="flex items-center justify-center flex-col mt-6">
          ...
          <div className="bg-white shadow rounded-md p-3 w-[400px] mt-5">
            ...
            <div className="mt-2 space-y-5">
              ...
              <div className="flex items-center justify-between text-red-600">
                ...
                <span>{Number(discount).toLocaleString("fa")} تومان</span>
              </div>
              <div className="flex items-center justify-between text-green-600">
                <span className="font-DanaDemiBold "> مقدار پرداختی : </span>
                <span>{Number(totalCount).toLocaleString("fa")} تومان</span>
              </div>
            </div>
          </div>
          <div className="bg-white shadow rounded-md p-3 w-[400px] mt-5">
          ...
          <Link
            to={"/my-account"}
            className="bg-green-600 text-white font-DanaDemiBold p-2 rounded-md mt-5"
          >
            رفتن به حساب کاربری
          </Link>
        </div>
