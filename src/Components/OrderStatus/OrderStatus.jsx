  ...
  return (
    <div className="flex items-center justify-between   font-DanaDemiBold">
      ...
      <div className="relative">
        <div className="w-10 h-10 rounded-full bg-white shadow flex-center relative shrink-0 order-active-circle">1</div>
        <span className="absolute -top-8 -right-3 w-[70px]">سبد خرید</span>
      </div>
      <span className="block w-full h-1.5 bg-gray-200"></span>
      <div className="relative">
        <div className="w-10 h-10 rounded-full bg-white shadow flex-center relative shrink-0 order-active-circle">2</div>
        <span className="absolute -top-8 -right-7 w-[115px]">جزییات پرداخت</span>
      </div>
      <span className="block w-full h-1.5 bg-gray-200"></span>
      <div className="relative">
        <div className="w-10 h-10 rounded-full bg-white shadow flex-center relative shrink-0 order-active-circle">3</div>
